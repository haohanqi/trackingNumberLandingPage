...
const DocumentDeliveryPrice = () => {
	return (
		...
		<TabContentWrapper >
			...
			<ContentList>60 CAD / transfer  </ContentList>
			...
			<ContentList> Including sealed boxes and sealed tapes    </ContentList>
...
export default DocumentDeliveryPrice